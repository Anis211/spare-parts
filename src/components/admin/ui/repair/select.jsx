  ...
  ({ className, children, ...props }, ref) => (
    <SelectPrimitive.Trigger
      ...
      style={{
        ...
        borderColor: "hsl(222 30% 22%)", // --input / --border
      }}
      {...props}
    >
      {children}
...
const SelectScrollUpButton = React.forwardRef(
  ({ className, ...props }, ref) => (
    <SelectPrimitive.ScrollUpButton
      ...
      {...props}
    >
      <ChevronUp className="h-4 w-4" style={{ color: "hsl(215 20% 65%)" }} />
    </SelectPrimitive.ScrollUpButton>
  )
);
...
const SelectScrollDownButton = React.forwardRef(
  ({ className, ...props }, ref) => (
    <SelectPrimitive.ScrollDownButton
      ...
      {...props}
    >
      <ChevronDown className="h-4 w-4" style={{ color: "hsl(215 20% 65%)" }} />
    </SelectPrimitive.ScrollDownButton>
  )
);
  ...
  ({ className, children, position = "popper", ...props }, ref) => (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        style={{
          backgroundColor: "hsl(222 47% 12%)", // --popover
...
const SelectItem = React.forwardRef(
  ({ className, children, ...props }, ref) => (
    <SelectPrimitive.Item
      ...
      style={{
        outline: "none",
        // Focus styles applied via :focus-within or JS if needed
      }}
      {...props}
    >
...
const SelectSeparator = React.forwardRef(({ className, ...props }, ref) => (
  <SelectPrimitive.Separator
    ...
    style={{ backgroundColor: "hsl(222 30% 20%)" }} // --muted
    {...props}
  />
));
